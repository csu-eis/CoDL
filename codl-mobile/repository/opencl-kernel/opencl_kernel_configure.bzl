...
def _opencl_encrypt_kernel_impl(repository_ctx):
    ...
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/activation_buffer.cl"))
    ...
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/bias_add_buffer.cl"))
    ...
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/concat_buffer.cl"))
    ...
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/deconv_2d_buffer.cl"))
    ...
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/eltwise_buffer.cl"))
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/fully_connected.cl"))
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/fully_connected_buffer.cl"))
    ...
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/matmul_buffer.cl"))
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/pad.cl"))
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/pad_buffer.cl"))
    ...
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/reduce_buffer.cl"))
    ...
    unused_var = repository_ctx.path(Label("//:mace/ops/opencl/cl/sqrdiff_mean_buffer.cl"))
