...
bazel build --config android --config optimization mace/libmace:libmace_dynamic --define neon=true --define opencl=true --define quantize=true --define rpcmem=false --cpu=arm64-v8a
