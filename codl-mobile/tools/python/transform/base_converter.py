...
class MaceKeyword(object):
    ...
    mace_output_padding_values_str = 'output_padding_values'
    ...
    mace_hidden_size_str = 'hidden_size'
    mace_linear_before_reset_str = 'linear_before_reset'
...
class ConverterUtil(object):
    ...
    @staticmethod
    def del_data_format_arg(op):
        ConverterUtil.del_arg(op, MaceKeyword.mace_data_format_str)
