...
extern void RegisterConv3D(OpRegistryBase *op_registry);
extern void RegisterConstantOfShape(OpRegistryBase *op_registry);
...
extern void RegisterExpand(OpRegistryBase *op_registry);
...
extern void RegisterGru(OpRegistryBase *op_registry);
...
extern void RegisterScatterND(OpRegistryBase *op_registry);
...
extern void RegisterWhere(OpRegistryBase *op_registry);
...
OpRegistry::OpRegistry() : OpRegistryBase() {
  ...
  ops::RegisterConv3D(this);
  ops::RegisterConstantOfShape(this);
