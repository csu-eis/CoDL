...
class Conv2dK1x1S2 : public Conv2dBase {
 public:
  Conv2dK1x1S2(const std::vector<int> &paddings, const Padding padding_type)
      : Conv2dBase({2, 2}, {1, 1}, paddings, padding_type) {}
  virtual ~Conv2dK1x1S2() {}
 ...
 private:
  void RearrangeInput(const Tensor &src, Tensor *dst);

  void RearrangeInputBlock4(const Tensor &src, Tensor *dst);
