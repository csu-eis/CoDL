...
MaceStatus PoolingDelegator<DeviceType::CPU, float>::Compute(
...
void PoolingDelegator<DeviceType::CPU, float>::MaxPooling(
    const OpContext *context,
    const float *input,
    const index_t *in_shape,
    const index_t *out_shape,
...
void PoolingDelegator<DeviceType::CPU, float>::AvgPooling(
    const OpContext *context,
    const float *input,
    const index_t *in_shape,
    const index_t *out_shape,
...
MaceStatus PoolingDelegator<DeviceType::CPU, uint8_t>::Compute(
    const OpContext *context,
    const uint8_t *input,
    const index_t *in_shape,
    const index_t *out_shape,
...
void PoolingDelegator<DeviceType::CPU, uint8_t>::MaxPooling(
    const OpContext *context,
    const uint8_t *input,
    const index_t *in_shape,
    const index_t *out_shape,
...
void PoolingDelegator<DeviceType::CPU, uint8_t>::AvgPooling(
    const OpContext *context,
    const uint8_t *input,
    const index_t *in_shape,
    const index_t *out_shape,
 ...
 public:
  explicit PoolingOpBase(OpConstructContext *context)
      : ConvPool2dOpBase(context),
        ...
        pooling_type_(static_cast<PoolingType>(Operation::GetOptionalArg<int>(
...
class PoolingOp<DeviceType::CPU, float> : public PoolingOpBase {
 public:
  explicit PoolingOp(OpConstructContext *context)
      : PoolingOpBase(context),
        delegator_(static_cast<PoolingType>(Operation::GetOptionalArg<int>(
            "pooling_type", static_cast<int>(AVG)))) {}
...
#if 0
    LOG(INFO) << "pooling_type " << static_cast<int>(pooling_type_)
              << ", round_type " << static_cast<int>(round_type_);
#endif

    delegator_.Compute(context,
                       input,
                       input_shape,
                       output_shape.data(),
                       kernels_.data(),
 ...
 private:
  PoolingDelegator<DeviceType::CPU, float> delegator_;
};
...
class PoolingOp<DeviceType::CPU, uint8_t> : public PoolingOpBase {
 ...
 private:
  PoolingDelegator<DeviceType::CPU, uint8_t> delegator_;
};
