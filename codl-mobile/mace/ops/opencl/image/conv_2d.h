...
extern std::vector<uint32_t> Conv2dK1x1LocalWS(OpenCLRuntime *runtime,
                                               const uint32_t *gws,
                                               const uint32_t kwg_size);

extern std::vector<uint32_t> Conv2dK3x3LocalWS(OpenCLRuntime *runtime,
                                               const uint32_t *gws,
                                               const uint32_t kwg_size);

extern std::vector<uint32_t> Conv2dLocalWS(OpenCLRuntime *runtime,
                                           const uint32_t *gws,
                                           const uint32_t kwg_size);
