...
#define READ_INPUT_IMAGE
#define READ_FILETER_IMAGE
#define READ_BIAS_IMAGE
#define COMPUTE
...
#else
    DATA_TYPE4 weights0 = 0;
    DATA_TYPE4 weights1 = 0;
    DATA_TYPE4 weights2 = 0;
    DATA_TYPE4 weights3 = 0;
#endif
...
#undef READ_INPUT_IMAGE
#undef READ_FILETER_IMAGE
#undef READ_BIAS_IMAGE
#undef COMPUTE
#undef WRITE_OUTPUT_IMAGE
