...
#ifndef MACE_OPS_OPENCL_BUFFER_PAD_H_
#define MACE_OPS_OPENCL_BUFFER_PAD_H_
...
class PadKernel : public OpenCLPadKernel {
 public:
  ...
  void set_paddings(const std::vector<int> *paddings) override {
    paddings_ = *paddings;
  }
...
#endif  // MACE_OPS_OPENCL_BUFFER_PAD_H_
